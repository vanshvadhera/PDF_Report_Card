...
function Ukg_Term3() {
  ...
  const fillPdfForm = async (student, pdfDoc) => {
    try {
      ...
      const teacher_ukg_2Url = student.teacher_ukg_2;
      const teacher_ukg_2Bytes = await fetch(teacher_ukg_2Url).then((res) =>
        res.arrayBuffer()
      );
      ...
      const teacher_ukg_2Image = await pdfDoc.embedJpg(teacher_ukg_2Bytes);
      ...
      seventhPage.drawText(student["I am conscious of personal hygiene_2"][0], {
        x:
          student["I am conscious of personal hygiene_2"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 673,
        size: 10,
      ...
      seventhPage.drawText(student["I am responsible and dependable_2"][0], {
        x:
          student["I am responsible and dependable_2"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 652,
        size: 10,
      ...
      seventhPage.drawText(student["I embrace teamwork_2"][0], {
        x: student["I embrace teamwork_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 630,
        size: 10,
        color: rgb(0, 0, 0),
      });
      ...
      seventhPage.drawText(student["I take care of personal belongings_2"][0], {
        x:
          student["I take care of personal belongings_2"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 590,
        size: 10,
      ...
      {
        student["SELF SMART Remarks_2"][0] &&
          seventhPage.drawText(student["SELF SMART Remarks_2"][0], {
            x: 353,
            y: 673,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SELF SMART Remarks_2"][1] &&
          seventhPage.drawText(student["SELF SMART Remarks_2"][1], {
            x: 353,
            y: 660,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SELF SMART Remarks_2"][2] &&
          seventhPage.drawText(student["SELF SMART Remarks_2"][2], {
            x: 353,
            y: 647,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SELF SMART Remarks_2"][3] &&
          seventhPage.drawText(student["SELF SMART Remarks_2"][3], {
            x: 353,
            y: 634,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      seventhPage.drawText(student["I am disciplined_2"][0], {
        x: student["I am disciplined_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 544,
        size: 10,
        color: rgb(0, 0, 0),
      });
      ...
      {
        student["MY MINDFULNESS Remarks_2"][0] &&
          seventhPage.drawText(student["MY MINDFULNESS Remarks_2"][0], {
            x: 353,
            y: 544,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MY MINDFULNESS Remarks_2"][1] &&
          seventhPage.drawText(student["MY MINDFULNESS Remarks_2"][1], {
            x: 353,
            y: 531,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MY MINDFULNESS Remarks_2"][2] &&
          seventhPage.drawText(student["MY MINDFULNESS Remarks_2"][2], {
            x: 353,
            y: 518,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MY MINDFULNESS Remarks_2"][3] &&
          seventhPage.drawText(student["MY MINDFULNESS Remarks_2"][3], {
            x: 353,
            y: 505,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      seventhPage.drawText(student["I can recollect_2"][0], {
        x: student["I can recollect_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 460,
        size: 10,
        color: rgb(0, 0, 0),
      });
      seventhPage.drawText(student["I can enact while reciting_2"][0], {
        x:
          student["I can enact while reciting_2"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 439,
        size: 10,
      ...
      seventhPage.drawText(student["I can express clearly_2"][0], {
        x: student["I can express clearly_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 418,
        size: 10,
        color: rgb(0, 0, 0),
      });
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_2"][0] &&
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_2"][1] &&
          seventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_2"][1],
            {
              x: 353,
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_2"][2] &&
          seventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_2"][2],
            {
              x: 353,
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_2"][3] &&
          seventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_2"][3],
            {
              x: 353,
      ...
      seventhPage.drawText(student["I can comprehend_2"][0], {
        x: student["I can comprehend_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 310,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["GENERAL AWARENESS Remarks_2"][0] &&
          seventhPage.drawText(student["GENERAL AWARENESS Remarks_2"][0], {
            x: 353,
            y: 352,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["GENERAL AWARENESS Remarks_2"][1] &&
          seventhPage.drawText(student["GENERAL AWARENESS Remarks_2"][1], {
            x: 353,
            y: 339,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["GENERAL AWARENESS Remarks_2"][2] &&
          seventhPage.drawText(student["GENERAL AWARENESS Remarks_2"][2], {
            x: 353,
            y: 326,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["GENERAL AWARENESS Remarks_2"][3] &&
          seventhPage.drawText(student["GENERAL AWARENESS Remarks_2"][3], {
            x: 353,
            y: 313,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      seventhPage.drawText(student["I listen attentively_2"][0], {
        x: student["I listen attentively_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 265,
        size: 10,
        color: rgb(0, 0, 0),
      });
      seventhPage.drawText(student["I can assimilate_2"][0], {
        x: student["I can assimilate_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 244,
        size: 10,
        color: rgb(0, 0, 0),
      });
      seventhPage.drawText(student["I can reciprocate_2"][0], {
        x: student["I can reciprocate_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 223,
        size: 10,
        color: rgb(0, 0, 0),
      });
      seventhPage.drawText(student["I can build new words_2"][0], {
        x: student["I can build new words_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 202,
        size: 10,
        color: rgb(0, 0, 0),
      });
      seventhPage.drawText(student["I am fluent_2"][0], {
        x: student["I am fluent_2"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 181,
        size: 10,
        color: rgb(0, 0, 0),
      });
      seventhPage.drawText(
        student["I have good eye and hand co-ordination_2"][0],
        {
          x:
            student["I have good eye and hand co-ordination_2"][0] ===
            "PROGRESSIVE"
      ...
      {
        student["LITERACY SMART ENGLISH Remarks_2"][0] &&
          seventhPage.drawText(student["LITERACY SMART ENGLISH Remarks_2"][0], {
            x: 353,
            y: 265,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["LITERACY SMART ENGLISH Remarks_2"][1] &&
          seventhPage.drawText(student["LITERACY SMART ENGLISH Remarks_2"][1], {
            x: 353,
            y: 252,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["LITERACY SMART ENGLISH Remarks_2"][2] &&
          seventhPage.drawText(student["LITERACY SMART ENGLISH Remarks_2"][2], {
            x: 353,
            y: 239,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eighthPage.drawText(student["श्रवण कौशल_2"][0], {
        x: student["श्रवण कौशल_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 693,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["समझ कौशल_2"][0], {
        x: student["समझ कौशल_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 672,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["एकाग्रता_2"][0], {
        x: student["एकाग्रता_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 650,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["शब्दकोश_2"][0], {
        x: student["शब्दकोश_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 629,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["स्पष्टता_2"][0], {
        x: student["स्पष्टता_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 608,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["अक्षर पहचान_2"][0], {
        x: student["अक्षर पहचान_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 587,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["स्वर संबंधी_2"][0], {
        x: student["स्वर संबंधी_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 566,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["हस्त लेखन_2"][0], {
        x: student["हस्त लेखन_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 545,
        size: 10,
        color: rgb(0, 0, 0),
      });
      ...
      eighthPage.drawText(
        student["I display logical understanding of concepts_2"][0],
        {
          x:
            student["I display logical understanding of concepts_2"][0] ===
            "PROGRESSIVE"
      ...
      eighthPage.drawText(
        student["I have a good mathematical understanding_2"][0],
        {
          x:
            student["I have a good mathematical understanding_2"][0] ===
            "PROGRESSIVE"
      ...
      eighthPage.drawText(student["I am an artist_2"][0], {
        x: student["I am an artist_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 413,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["I can use colours skillfully_2"][0], {
        x:
          student["I can use colours skillfully_2"][0] === "PROGRESSIVE"
            ? 303
            : 313,
        y: 392,
        size: 10,
      ...
      {
        student["AESTHETIC SKILLS Remarks_2"][0] &&
          eighthPage.drawText(student["AESTHETIC SKILLS Remarks_2"][0], {
            x: 390,
            y: 413,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["AESTHETIC SKILLS Remarks_2"][1] &&
          eighthPage.drawText(student["AESTHETIC SKILLS Remarks_2"][1], {
            x: 390,
            y: 400,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["AESTHETIC SKILLS Remarks_2"][2] &&
          eighthPage.drawText(student["AESTHETIC SKILLS Remarks_2"][2], {
            x: 390,
            y: 387,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eighthPage.drawText(student["I can twirl_2"][0], {
        x: student["I can twirl_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 305,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["I am flexible_2"][0], {
        x: student["I am flexible_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 284,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["DANCE SMART Remarks_2"][0] &&
          eighthPage.drawText(student["DANCE SMART Remarks_2"][0], {
            x: 390,
            y: 307,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["DANCE SMART Remarks_2"][1] &&
          eighthPage.drawText(student["DANCE SMART Remarks_2"][1], {
            x: 390,
            y: 294,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["DANCE SMART Remarks_2"][2] &&
          eighthPage.drawText(student["DANCE SMART Remarks_2"][2], {
            x: 390,
            y: 281,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eighthPage.drawText(student["I can sing in harmony_2"][0], {
        x: student["I can sing in harmony_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 240,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["I am lyrical_2"][0], {
        x: student["I am lyrical_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 220,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["MUSIC SMART Remarks_2"][0] &&
          eighthPage.drawText(student["MUSIC SMART Remarks_2"][0], {
            x: 390,
            y: 242,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MUSIC SMART Remarks_2"][1] &&
          eighthPage.drawText(student["MUSIC SMART Remarks_2"][1], {
            x: 390,
            y: 229,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MUSIC SMART Remarks_2"][2] &&
          eighthPage.drawText(student["MUSIC SMART Remarks_2"][2], {
            x: 390,
            y: 216,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eighthPage.drawText(student["I am well coordinated_2"][0], {
        x: student["I am well coordinated_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 176,
        size: 10,
        color: rgb(0, 0, 0),
      });
      ...
      eighthPage.drawText(student["I am prompt and swift_2"][0], {
        x: student["I am prompt and swift_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 134,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eighthPage.drawText(student["I display team spirit_2"][0], {
        x: student["I display team spirit_2"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 113,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["SPORTS SMARTS Remarks_2"][0] &&
          eighthPage.drawText(student["SPORTS SMARTS Remarks_2"][0], {
            x: 390,
            y: 176,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SPORTS SMARTS Remarks_2"][1] &&
          eighthPage.drawText(student["SPORTS SMARTS Remarks_2"][1], {
            x: 390,
            y: 163,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SPORTS SMARTS Remarks_2"][2] &&
          eighthPage.drawText(student["SPORTS SMARTS Remarks_2"][2], {
            x: 390,
            y: 150,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SPORTS SMARTS Remarks_2"][3] &&
          eighthPage.drawText(student["SPORTS SMARTS Remarks_2"][3], {
            x: 390,
            y: 137,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      ninthPage.drawText(student["I am ______ cms tall_2"][0], {
        x: 135,
        y: 681,
        size: 14,
        color: rgb(0, 0, 0),
      });
      ninthPage.drawText(student["I weigh _______ kgs_2"][0], {
        x: 159,
        y: 663,
        size: 14,
        color: rgb(0, 0, 0),
      ...
      ninthPage.drawText(
        student["I believe in team building_2"][0].slice(0, 20),
        {
          x: 305,
          y: 340,
          size: 12,
      ...
      ninthPage.drawText(
        student["I believe in team building_2"][0].slice(21, 40),
        {
          x: 305,
          y: 327,
          size: 12,
      ...
      eleventhPage.drawText(
        student["I am conscious of personal hygiene_3"][0],
        {
          x:
            student["I am conscious of personal hygiene_3"][0] === "PROGRESSIVE"
              ? 267
              : 277,
          y: 673,
          size: 10,
      ...
      eleventhPage.drawText(student["I am responsible and dependable_3"][0], {
        x:
          student["I am responsible and dependable_3"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 652,
        size: 10,
      ...
      eleventhPage.drawText(student["I embrace teamwork_3"][0], {
        x: student["I embrace teamwork_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 630,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I am polite and courteous_3"][0], {
        x:
          student["I am polite and courteous_3"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 610,
        size: 10,
      ...
      eleventhPage.drawText(
        student["I take care of personal belongings_3"][0],
        {
          x:
            student["I take care of personal belongings_3"][0] === "PROGRESSIVE"
              ? 267
              : 277,
          y: 590,
          size: 10,
      ...
      {
        student["SELF SMART Remarks_3"][0] &&
          eleventhPage.drawText(student["SELF SMART Remarks_3"][0], {
            x: 353,
            y: 673,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SELF SMART Remarks_3"][1] &&
          eleventhPage.drawText(student["SELF SMART Remarks_3"][1], {
            x: 353,
            y: 660,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SELF SMART Remarks_3"][2] &&
          eleventhPage.drawText(student["SELF SMART Remarks_3"][2], {
            x: 353,
            y: 647,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SELF SMART Remarks_3"][3] &&
          eleventhPage.drawText(student["SELF SMART Remarks_3"][3], {
            x: 353,
            y: 634,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eleventhPage.drawText(student["I am disciplined_3"][0], {
        x: student["I am disciplined_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 544,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I am an eloquent speaker_3"][0], {
        x:
          student["I am an eloquent speaker_3"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 525,
        size: 10,
      ...
      eleventhPage.drawText(student["I take pride in my work_3"][0], {
        x:
          student["I take pride in my work_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 503,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["MY MINDFULNESS Remarks_3"][0] &&
          eleventhPage.drawText(student["MY MINDFULNESS Remarks_3"][0], {
            x: 353,
            y: 544,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MY MINDFULNESS Remarks_3"][1] &&
          eleventhPage.drawText(student["MY MINDFULNESS Remarks_3"][1], {
            x: 353,
            y: 531,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MY MINDFULNESS Remarks_3"][2] &&
          eleventhPage.drawText(student["MY MINDFULNESS Remarks_3"][2], {
            x: 353,
            y: 518,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MY MINDFULNESS Remarks_3"][3] &&
          eleventhPage.drawText(student["MY MINDFULNESS Remarks_3"][3], {
            x: 353,
            y: 505,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eleventhPage.drawText(student["I can recollect_3"][0], {
        x: student["I can recollect_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 460,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I can enact while reciting_3"][0], {
        x:
          student["I can enact while reciting_3"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 439,
        size: 10,
      ...
      eleventhPage.drawText(student["I can express clearly_3"][0], {
        x: student["I can express clearly_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 418,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I am engaged and involved_3"][0], {
        x:
          student["I am engaged and involved_3"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 397,
        size: 10,
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_3"][0] &&
          eleventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_3"][0],
            {
              x: 353,
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_3"][1] &&
          eleventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_3"][1],
            {
              x: 353,
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_3"][2] &&
          eleventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_3"][2],
            {
              x: 353,
      ...
      {
        student["STORYTELLING AND RECITATION Remarks_3"][3] &&
          eleventhPage.drawText(
            student["STORYTELLING AND RECITATION Remarks_3"][3],
            {
              x: 353,
      ...
      eleventhPage.drawText(student["I demonstrate curiosity_3"][0], {
        x:
          student["I demonstrate curiosity_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 352,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I can observe and explore_3"][0], {
        x:
          student["I can observe and explore_3"][0] === "PROGRESSIVE"
            ? 267
            : 277,
        y: 331,
        size: 10,
      ...
      eleventhPage.drawText(student["I can comprehend_3"][0], {
        x: student["I can comprehend_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 310,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["GENERAL AWARENESS Remarks_3"][0] &&
          eleventhPage.drawText(student["GENERAL AWARENESS Remarks_3"][0], {
            x: 353,
            y: 352,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["GENERAL AWARENESS Remarks_3"][1] &&
          eleventhPage.drawText(student["GENERAL AWARENESS Remarks_3"][1], {
            x: 353,
            y: 339,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["GENERAL AWARENESS Remarks_3"][2] &&
          eleventhPage.drawText(student["GENERAL AWARENESS Remarks_3"][2], {
            x: 353,
            y: 326,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["GENERAL AWARENESS Remarks_3"][3] &&
          eleventhPage.drawText(student["GENERAL AWARENESS Remarks_3"][3], {
            x: 353,
            y: 313,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      eleventhPage.drawText(student["I listen attentively_3"][0], {
        x: student["I listen attentively_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 265,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I can assimilate_3"][0], {
        x: student["I can assimilate_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 244,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I can reciprocate_3"][0], {
        x: student["I can reciprocate_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 223,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I can build new words_3"][0], {
        x: student["I can build new words_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 202,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(student["I am fluent_3"][0], {
        x: student["I am fluent_3"][0] === "PROGRESSIVE" ? 267 : 277,
        y: 181,
        size: 10,
        color: rgb(0, 0, 0),
      });
      eleventhPage.drawText(
        student["I have good eye and hand co-ordination_3"][0],
        {
          x:
            student["I have good eye and hand co-ordination_3"][0] ===
            "PROGRESSIVE"
      ...
      {
        student["LITERACY SMART ENGLISH Remarks_3"][0] &&
          eleventhPage.drawText(
            student["LITERACY SMART ENGLISH Remarks_3"][0],
            {
              x: 353,
      ...
      {
        student["LITERACY SMART ENGLISH Remarks_3"][1] &&
          eleventhPage.drawText(
            student["LITERACY SMART ENGLISH Remarks_3"][1],
            {
              x: 353,
      ...
      {
        student["LITERACY SMART ENGLISH Remarks_3"][2] &&
          eleventhPage.drawText(
            student["LITERACY SMART ENGLISH Remarks_3"][2],
            {
              x: 353,
      ...
      twelfthPage.drawText(student["श्रवण कौशल_3"][0], {
        x: student["श्रवण कौशल_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 693,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["समझ कौशल_3"][0], {
        x: student["समझ कौशल_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 672,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["एकाग्रता_3"][0], {
        x: student["एकाग्रता_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 650,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["शब्दकोश_3"][0], {
        x: student["शब्दकोश_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 629,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["स्पष्टता_3"][0], {
        x: student["स्पष्टता_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 608,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["अक्षर पहचान_3"][0], {
        x: student["अक्षर पहचान_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 587,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["स्वर संबंधी_3"][0], {
        x: student["स्वर संबंधी_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 566,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["हस्त लेखन_3"][0], {
        x: student["हस्त लेखन_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 545,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["मेरी भाषा Remarks_3"][0] &&
          twelfthPage.drawText(student["मेरी भाषा Remarks_3"][0], {
            x: 390,
            y: 693,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["मेरी भाषा Remarks_3"][1] &&
          twelfthPage.drawText(student["मेरी भाषा Remarks_3"][1], {
            x: 390,
            y: 680,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["मेरी भाषा Remarks_3"][2] &&
          twelfthPage.drawText(student["मेरी भाषा Remarks_3"][2], {
            x: 390,
            y: 667,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      twelfthPage.drawText(
        student["I display logical understanding of concepts_3"][0],
        {
          x:
            student["I display logical understanding of concepts_3"][0] ===
            "PROGRESSIVE"
      ...
      twelfthPage.drawText(
        student["I have a good mathematical understanding_3"][0],
        {
          x:
            student["I have a good mathematical understanding_3"][0] ===
            "PROGRESSIVE"
      ...
      twelfthPage.drawText(
        student["I can perform mathematical operations_3"][0],
        {
          x:
            student["I can perform mathematical operations_3"][0] ===
            "PROGRESSIVE"
      ...
      {
        student["NUMERACY SMART Remarks_3"][0] &&
          twelfthPage.drawText(student["NUMERACY SMART Remarks_3"][0], {
            x: 390,
            y: 500,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["NUMERACY SMART Remarks_3"][1] &&
          twelfthPage.drawText(student["NUMERACY SMART Remarks_3"][1], {
            x: 390,
            y: 487,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      twelfthPage.drawText(student["I am an artist_3"][0], {
        x: student["I am an artist_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 413,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["I can use colours skillfully_3"][0], {
        x:
          student["I can use colours skillfully_3"][0] === "PROGRESSIVE"
            ? 303
            : 313,
        y: 392,
        size: 10,
      ...
      twelfthPage.drawText(
        student["I use vivid imagination with play-doh_3"][0],
        {
          x:
            student["I use vivid imagination with play-doh_3"][0] ===
            "PROGRESSIVE"
      ...
      twelfthPage.drawText(
        student["I work collaboratively in art and craft_3"][0],
        {
          x:
            student["I work collaboratively in art and craft_3"][0] ===
            "PROGRESSIVE"
      ...
      {
        student["AESTHETIC SKILLS Remarks_3"][0] &&
          twelfthPage.drawText(student["AESTHETIC SKILLS Remarks_3"][0], {
            x: 390,
            y: 413,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["AESTHETIC SKILLS Remarks_3"][1] &&
          twelfthPage.drawText(student["AESTHETIC SKILLS Remarks_3"][1], {
            x: 390,
            y: 400,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["AESTHETIC SKILLS Remarks_3"][2] &&
          twelfthPage.drawText(student["AESTHETIC SKILLS Remarks_3"][2], {
            x: 390,
            y: 387,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      twelfthPage.drawText(student["I can twirl_3"][0], {
        x: student["I can twirl_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 305,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["I am flexible_3"][0], {
        x: student["I am flexible_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 284,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["DANCE SMART Remarks_3"][0] &&
          twelfthPage.drawText(student["DANCE SMART Remarks_3"][0], {
            x: 390,
            y: 307,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["DANCE SMART Remarks_3"][1] &&
          twelfthPage.drawText(student["DANCE SMART Remarks_3"][1], {
            x: 390,
            y: 294,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["DANCE SMART Remarks_3"][2] &&
          twelfthPage.drawText(student["DANCE SMART Remarks_3"][2], {
            x: 390,
            y: 281,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      twelfthPage.drawText(student["I can sing in harmony_3"][0], {
        x: student["I can sing in harmony_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 240,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["I am lyrical_3"][0], {
        x: student["I am lyrical_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 220,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["MUSIC SMART Remarks_3"][0] &&
          twelfthPage.drawText(student["MUSIC SMART Remarks_3"][0], {
            x: 390,
            y: 242,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MUSIC SMART Remarks_3"][1] &&
          twelfthPage.drawText(student["MUSIC SMART Remarks_3"][1], {
            x: 390,
            y: 229,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["MUSIC SMART Remarks_3"][2] &&
          twelfthPage.drawText(student["MUSIC SMART Remarks_3"][2], {
            x: 390,
            y: 216,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      twelfthPage.drawText(student["I am well coordinated_3"][0], {
        x: student["I am well coordinated_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 176,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["I show strength and endurance_3"][0], {
        x:
          student["I show strength and endurance_3"][0] === "PROGRESSIVE"
            ? 303
            : 313,
        y: 155,
        size: 10,
      ...
      twelfthPage.drawText(student["I am prompt and swift_3"][0], {
        x: student["I am prompt and swift_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 134,
        size: 10,
        color: rgb(0, 0, 0),
      });
      twelfthPage.drawText(student["I display team spirit_3"][0], {
        x: student["I display team spirit_3"][0] === "PROGRESSIVE" ? 303 : 313,
        y: 113,
        size: 10,
        color: rgb(0, 0, 0),
      });
      {
        student["SPORTS SMARTS Remarks_3"][0] &&
          twelfthPage.drawText(student["SPORTS SMARTS Remarks_3"][0], {
            x: 390,
            y: 176,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SPORTS SMARTS Remarks_3"][1] &&
          twelfthPage.drawText(student["SPORTS SMARTS Remarks_3"][1], {
            x: 390,
            y: 163,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SPORTS SMARTS Remarks_3"][2] &&
          twelfthPage.drawText(student["SPORTS SMARTS Remarks_3"][2], {
            x: 390,
            y: 150,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      {
        student["SPORTS SMARTS Remarks_3"][3] &&
          twelfthPage.drawText(student["SPORTS SMARTS Remarks_3"][3], {
            x: 390,
            y: 137,
            size: 10,
            color: rgb(0, 0, 0),
      ...
      //   thirteenPage
      thirteenPage.drawText(student["I am ______ cms tall_3"][0], {
        x: 120,
        y: 598,
        size: 14,
        color: rgb(0, 0, 0),
      });
      thirteenPage.drawText(student["I weigh _______ kgs_3"][0], {
        x: 150,
        y: 577,
        size: 14,
        color: rgb(0, 0, 0),
      ...
      thirteenPage.drawText(student["I aspire to be_3"][0], {
        x: 125,
        y: 332,
        size: 14,
        color: rgb(0, 0, 0),
      ...
      thirteenPage.drawText(student["I assist others_3"][0], {
        x: 315,
        y: 110,
        size: 12,
        color: rgb(0, 0, 0),
      });
      thirteenPage.drawText(student["I willingly share my resources_3"][0], {
        x: 315,
        y: 186,
        size: 12,
        color: rgb(0, 0, 0),
      ...
      thirteenPage.drawText(student["I believe in team building_3"][0], {
        x: 315,
        y: 147,
        size: 12,
        color: rgb(0, 0, 0),
      ...
      fourteenPage.drawImage(teacher_ukg_2Image, {
        x: 150,
        y: 315,
        width: 70,
        height: 30,
